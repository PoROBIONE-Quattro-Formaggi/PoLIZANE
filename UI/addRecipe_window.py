...
class Ui_add_recipe_window(object):
    ...
    def retranslateUi(self, add_recipe_window):
        ...
        self.ingredients_list.setStatusTip(_translate("add_recipe_window", "Added ingredient list"))
        self.timers_list.setStatusTip(_translate("add_recipe_window", "Added timers list"))
        self.add_button_ingredient.setStatusTip(
            _translate("add_recipe_window", "Click plus to add new ingredient to the recipe"))
        ...
        self.delete_button.setStatusTip(
            _translate("add_recipe_window", "Click delete if you don\'t want to create this recipe"))
