...
class Ui_ViewRecipeWindow(object):
    def setupUi(self, ViewRecipeWindow):
        ...
        self.recipeName.setGeometry(QtCore.QRect(600, 0, 350, 100))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(26)
        self.recipeName.setFont(font)
        self.recipeName.setStyleSheet("color: rgb(49, 87, 44)")
        self.recipeName.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
...
"border-radius:12px;")
        ...
        self.stepsTitle.setGeometry(QtCore.QRect(70, 280, 300, 41))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(20)
        self.stepsTitle.setFont(font)
        self.stepsTitle.setStyleSheet("color: rgb(49, 87, 44)")
        self.stepsTitle.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
...
"")
        ...
        self.ingredientsTitle.setGeometry(QtCore.QRect(70, 600, 300, 41))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(20)
        self.ingredientsTitle.setFont(font)
        self.ingredientsTitle.setStyleSheet("color: rgb(49, 87, 44)")
        self.ingredientsTitle.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.ingredientsTitle.setObjectName("ingredientsTitle")
        self.timersTitle = QtWidgets.QLabel(self.viewRecipeScreen)
        self.timersTitle.setGeometry(QtCore.QRect(620, 600, 300, 41))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(20)
        self.timersTitle.setFont(font)
        self.timersTitle.setStyleSheet("color: rgb(49, 87, 44)")
        self.timersTitle.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
